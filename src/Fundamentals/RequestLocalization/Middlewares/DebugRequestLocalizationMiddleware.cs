...
namespace RequestLocalization.Middlewares;

/// <summary>
/// <see cref="RequestLocalizationMiddleware"/> copy for debug
/// </summary>
public class DebugRequestLocalizationMiddleware
{
    ...
    public DebugRequestLocalizationMiddleware(RequestDelegate next, IOptions<RequestLocalizationOptions> options, ILoggerFactory loggerFactory)
    {
