...
internal static class AssertExtensions
{
    ...
    {
        Assert.IsGreaterThan(min, actual, $"The {nameof(actual)} value {actual} was not larger than {nameof(min)} value {min}");
    }
    public static void IsLargerThanOrEqual<T>(this Assert assert, T min, T actual) where T : IComparisonOperators<T, T, bool>
    {
        Assert.IsGreaterThanOrEqualTo(min, actual, $"The {nameof(actual)} value {actual} was not larger than or equal to {nameof(min)} value {min}");
    }
    public static void IsSmallerThan<T>(this Assert assert, T min, T actual) where T : IComparisonOperators<T, T, bool>
    {
        Assert.IsLessThan(min, actual, $"The {nameof(actual)} value {actual} was not smaller than {nameof(min)} value {min}");
    }
    public static void IsSmallerThanOrEqual<T>(this Assert assert, T min, T actual) where T : IComparisonOperators<T, T, bool>
    {
        Assert.IsLessThanOrEqualTo(min, actual, $"The {nameof(actual)} value {actual} was not smaller than or equal to {nameof(min)} value {min}");
    }
